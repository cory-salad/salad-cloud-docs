...
- `Instance Interrupted (Requested Disk Space Exceeded)` - The container went beyond the allocated disk space. Either
  select additional disk space, or modify your workload to use less space. 
